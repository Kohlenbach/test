...
const getSequenceOfMoves = require('../tools/getSequenceOfMoves')
const verifyIsBot = require('../tools/verifyIsBot')

exports.botProtection = function(data) {
    const slicedSquences = getSequenceOfMoves(data)
    
    return verifyIsBot(slicedSquences)
}